...
TimeLayer::TimeLayer(EsriRuntimeQt::GraphicsLayer *graphicsLayer, TimeFieldInfo *timeInfo, const QString &dateTimeFormat, QObject *parent) :
    QObject(parent),
...
TimeFieldInfo *TimeLayer::timeInfo()
{
    return m_timeInfo;
}
